...
_QWEN3_MODULE = "moe_store.wrappers.qwen3_paged_attention"
...
def _resolve_unsupported_mla_types() -> tuple[type, ...]:
    candidates = (
        (
            "moe_store.wrappers.deepseek_v2_paged_attention",
            "DeepseekV2PagedAttention",
        ),
        (
            "moe_store.wrappers.deepseek_v3_paged_attention",
            "DeepseekV3PagedAttention",
        ),
        (
            "moe_store.wrappers.modeling_deepseek_v2",
            "DeepseekV2PagedAttention",
        ),
        (
            "moe_store.wrappers.modeling_deepseek_v3",
            "DeepseekV3PagedAttention",
        ),
    )
    resolved: list[type] = []
