...
backend -> ``index_copy_``) is required because the serving runner pads
every batch to its longest query.
"""

from __future__ import annotations

from typing import Any, ClassVar, Optional, Protocol, Union, cast
